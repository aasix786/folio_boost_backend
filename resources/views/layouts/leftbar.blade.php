<div class="leftbar">
    ...
    <div class="sidebar">
        <!-- Start Logobar -->
        <div class="logobar">
            <a href="{{url('/')}}" class="logo logo-large"><img src="{{asset('assets/logo.png')}}" class="img-fluid" alt="logo"></a>
            ...
            <ul class="vertical-menu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <i class="ri-pencil-ruler-line"></i><span>Contests</span><i class="ri-arrow-right-s-line"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{url('/contests')}}">List Contests</a></li>
                        <li><a href="{{url('/add-contest')}}">Add Contest</a></li>
